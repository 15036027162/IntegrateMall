<template>
  <div class="fixedBg">
    <div class="po-absolute modelMess modelMess1">
      <div class="el-icon-close po-absolute iconCLose" @click="closeFamily"></div>
      <h1 class="modelTitle">添加家庭户</h1>
      <!--当前手机号-->
      <el-form ref="editChangeMobileForm" :model="addFamilyForm" :rules="familyRules" label-width="100px">
        <el-form-item label="门牌号：" prop="houseNumber">
          <el-input v-model="addFamilyForm.houseNumber" placeholder="请输入5位以内的整数"></el-input>
        ...
        <el-form-item label="区域选择：" required class="selectitems">
          <provinces @changeTown="changeTown" :isadd="provincesobj1"></provinces>
          <div class="el-form-item__error" v-show="iscun">请选择到村</div>
        </el-form-item>
        <el-form-item label="所属组：" prop="groups">
          <el-select clearable filterable v-model="addFamilyForm.groups" placeholder="请选择" @change="changename">
        ...
        <el-form-item label="户主名称：" prop="doorName">
          <el-input v-model="addFamilyForm.doorName" placeholder="请输入户主名称"></el-input>
        </el-form-item>
        <el-form-item label="身份证号：" prop="idcard">
          <el-input v-model="addFamilyForm.idcard" placeholder="请输入身份证号"></el-input>
        </el-form-item>
        <el-form-item style="text-align: center;position:relative;left: -45px">
          <el-button size="medium" @click="closeFamily('editChangeMobileForm')" style="margin-right: 30px">取消</el-button>
          <el-button type="primary" size="medium" @click="submitFamily('editChangeMobileForm')">确定添加</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
