...
<template>
  <div class>
    <div class="rightBtn">
      <el-button type="text" @click="downLoad()" v-if="isAuth('web:family:download')">下载家庭二维码</el-button>
      <!-- v-if="isAuth('base:door:batdown')" -->
    </div>
    ...
    <div class="familyInfo">
      ...
      <div class="familyInfo1">
        ...
        <div class="familyItem">
          身份证号
          <span>{{familyInfo.idcard?familyInfo.idcard:'无'}}</span>
        </div>
      </div>
      <div class="familyInfo1">
        <div class="familyItem">
...
export default {
  ...
  methods: {
    downLoad() {
      var url =
        baseUrl +
        "jinshimember/v2/w/member/downCode?doorNum=" +
        this.doorNum +
        "&doorName=" +
    ...
    download(base64) {
      ...
      if (this.familyInfo.doorName) {
        str =
          this.familyInfo.villageName +
          this.familyInfo.groupName +
          this.familyInfo.houseNumber +
          this.familyInfo.doorName +
          "家";
