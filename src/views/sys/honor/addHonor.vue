<template>
    <div class="addHonor_content">
        <el-form ref="editForm" :model="editForm" :rules="editRules" label-width="130px">
            ...
            <!--<el-form-item label="徽章显示：" required>
                <el-radio-group v-model="editForm.showPic">
                    <el-radio :label="1">所有家庭可见</el-radio>
                    <el-radio :label="0">获得家庭可见</el-radio>
                </el-radio-group>
            </el-form-item>-->
    ...
    export default {
        ...
        data(){
            return{
                ...
                // upLoadApiUrl: 'http://47.102.222.137:10000/commonality/v1/qiNiuYunUpload/singleFileUpload', // 图片上传接口
        ...
        methods:{
            ...
            submitForm(){
                ...
                this.$refs['editForm'].validate(async (valid) => {
                    if (valid) {
                        this.isdisable = true
                        let res = await this.$http.commendationSetAdd(dataObj);
                        if(res.status==='success'){
                            this.$message({
                                type: 'success',
                                message: res.msg,
