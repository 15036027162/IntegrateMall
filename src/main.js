...
import { setStore,getStore, removeStore,setSessionStore,getSessionStore,removeSessionStore,formatDateTime,isAuth} from "./config/mUtils";
...
Vue.prototype.openLoading = function() {
    const loading = this.$loading({           // 声明一个loading对象
        lock: true,                             // 是否锁屏
        text: '加载中...',                     // 加载动画的文字
        spinner: 'el-icons-loading',             // 引入的loading图标
