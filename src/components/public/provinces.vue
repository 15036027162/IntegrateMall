...
<template>
  ...
  <div class="formItem">
    ...
    <div class="formItem">
      ...
      <el-select v-model="searchForm.cityCode" placeholder="--请选择县--" filterable :disabled="disableSelectCity" clearable>
    ...
    <!-- <el-form-item label> -->
    <div class="formItem">
      <el-select v-model="searchForm.townCode" placeholder="--请选择镇--" @change="changeTown" filterable :disabled="disableSelectTown" clearable>
    ...
    <!-- <el-form-item label> -->
    <div class="formItem">
      <el-select v-model="searchForm.villageCode" placeholder="--请选择村--" @change="changeVillage" filterable :disabled="disableSelectVillage" clearable>
